defmodule MoodleNet.Repo.Migrations.RemoveUnusedFromMoodleNet do
  ...
  def up do
    ...
    # CommonsPub.ReleaseTasks.remove_meta_table("vf_spatial_things")

    # CommonsPub.ReleaseTasks.remove_meta_table("vf_measure")
    # CommonsPub.ReleaseTasks.remove_meta_table("vf_unit")
