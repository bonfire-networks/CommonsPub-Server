...
defmodule MoodleNet.Test.Trendy do
  @moduledoc """
  ...
  def flat_pam(list, fun) when is_list(list)
  and is_function(fun, 1), do: flat_pam(list, [], fun)
  ...
  and is_list(as)
  and is_list(bs), do: piz(as, bs, [], fun)
