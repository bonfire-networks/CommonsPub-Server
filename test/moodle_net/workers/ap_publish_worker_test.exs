defmodule Moodlenet.Workers.APPpublishWorkerTest do
  ...
  describe "false locality checks" do
    test "it doesn't federate remote resource" do
      ...
      assert :ignored = APPublishWorker.perform(%{"context_id" => resource.id, "verb" => "create"}, %{})
    end
    ...
    test "it doesn't federate remote communities" do
      ...
      assert :ignored = APPublishWorker.perform(%{"context_id" => community.id, "verb" => "create"}, %{})
    end
  ...
  describe "true locality checks" do
    test "it does federate local comments" do
      ...
      assert {:ok, _} = APPublishWorker.perform(%{"context_id" => comment.id, "verb" => "create"}, %{})
    end
    ...
    test "it does federate local resources" do
      ...
      assert {:ok, _} = APPublishWorker.perform(%{"context_id" => resource.id, "verb" => "create"}, %{})
    end

    test "it does federate local communities" do
      community = fake_user!() |> fake_community!()

      assert {:ok, _} = APPublishWorker.perform(%{"context_id" => community.id, "verb" => "create"}, %{})
    end
    ...
    test "it does federate local collections" do
      ...
      assert {:ok, _} = APPublishWorker.perform(%{"context_id" => collection.id, "verb" => "create"}, %{})
    end
    ...
    test "it does federate local follows" do
      ...
      assert {:ok, _} = APPublishWorker.perform(%{"context_id" => follow.id, "verb" => "create"}, %{})
    end
    ...
    test "it does federate local likes" do
      ...
      assert {:ok, _, _} = APPublishWorker.perform(%{"context_id" => like.id, "verb" => "create"}, %{})
    end
  end
  ...
  describe "deletes" do
    test "it federates an undo follow activity" do
      ...
      assert {:ok, activity} = APPublishWorker.perform(%{"context_id" => deleted_follow.id, "verb" => "delete"}, %{})
    ...
    test "it federates an undo like activity do" do
      ...
      assert {:ok, activity, _, _} = APPublishWorker.perform(%{"context_id" => deleted_like.id, "verb" => "delete"}, %{})
      assert activity.data["type"] == "Undo"
    end
  end
end
