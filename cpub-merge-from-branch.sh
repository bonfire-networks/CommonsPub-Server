...
for file in README.md config/docker.env config/docker.dev.env Makefile docker-compose.yml docker-compose.pi.yml .gitlab-ci.yml lib/moodle_net_web/graphql/schema.ex
do
    git reset HEAD ${file}
    git checkout -- ${file}
done
