defmodule Tag.Migrations do
  ...
  def up() do
    create_pointable_table(:taggable, "TAGSCANBECATEG0RY0RHASHTAG") do
      ...
      add(:context_id, references(Pointers.Config.pointer_table(), on_delete: :nilify_all))
      # eg. Mamals is a parent of Cat
      add(:parent_tag_id, references(:taggable, on_delete: :nilify_all))
      # eg. Olive Oil is the same as Huile d'olive
      add(:same_as_tag_id, references(:taggable, on_delete: :nilify_all))
