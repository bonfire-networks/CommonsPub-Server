...
defmodule MoodleNet.Follows do
  ...
  defp unsubscribe(%{creator_id: creator_id, context_id: context_id, is_local: true, muted_at: nil}) do
    case FeedSubscriptions.one(creator_id: creator_id, context_id: context_id) do
