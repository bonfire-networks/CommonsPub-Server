...
- [Updating to New Releases](#updating-to-new-releases-of-create-react-app)
...
The project uses TypeScript. Webpack is configured to compile the TypeScript files and also pass them through Babel,
so the project supports, in addition to [ES6](https://github.com/lukehoban/es6features) syntax features:
...
Manually create the property `setupTestFrameworkScriptFile` in the configuration for Jest, something like the following:
...
runtime caching strategy for those requests, you can configure the
