...
const Home: React.SFC<Props> = props => (
  <Wrapper>
    ...
    <blockquote>
      Do educators want to join communities to curate collections of resources?
    </blockquote>
    <p>
      ...
      experiences.
      <br />
      Although you’re one of only 100 people who have an account to be involved
      in the initial testing of MoodleNet, this isn’t a ‘closed’ environment.
      ...
      <br />
      We’re really looking forward to seeing how you use MoodleNet to share and
      curate resources, and collaborate with other educators!
      <br />
